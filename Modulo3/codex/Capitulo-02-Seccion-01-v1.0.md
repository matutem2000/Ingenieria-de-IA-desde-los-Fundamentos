...
Así como un ingeniero civil debe conocer las partes que componen una estructura antes de diseñar un edificio, un ingenieros de IA necesita comprender cada componente del contexto antes de construir un asistente, un agente o una aplicación basada en LLM.
...
El contexto no es un elemento único sino un ecosistema formado por múltiples componentes que evolucionan continuamente. El trabajo del ingenieros de IA consiste en diseñar, coordinar y mantener ese ecosistema para que el modelo disponga siempre de la información adecuada.
