...
- las jerarquías de precedencia permiten resolver conflictos entre capas de manera predecible.
...
```text
  ...
  Prompt              Arquitectura           Información
     ...
     ┌──────────┬───────────┼──────────────┬───────────┐
     │          │           │              │           │
  Sistema   Políticas    Memoria       Historial   Ejecución
     │          │           │              │           │
     └──────────┴───────────┼──────────────┴───────────┘
                            │
               ┌────────────┴────────────┐
...
7. ¿Cómo se resuelve un conflicto entre una instrucción del sistema y una solicitud del usuario?
...
- qué políticas o restricciones parecen estar presentes;
...
- omitir las políticas de precedencia ante conflictos entre capas.
