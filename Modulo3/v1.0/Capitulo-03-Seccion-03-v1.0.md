...
Los tokenizadores modernos utilizan algoritmos como Byte Pair Encoding (BPE) o SentencePiece, que encuentran unidades reutilizables para representar eficientemente millones de textos diferentes.
...
Un tokenizador podría dividirla en varias partes reutilizables —como "inter", "nacional", "ización"— mientras que otro podría representarla con una combinación completamente diferente.
...
# Implicancias para el AI Engineer
...
- Medir el consumo de tokens durante el desarrollo con las herramientas propias de cada proveedor.
- No asumir equivalencias fijas entre palabras y tokens.
- Probar el comportamiento con el modelo definitivo, no con aproximaciones genéricas.
