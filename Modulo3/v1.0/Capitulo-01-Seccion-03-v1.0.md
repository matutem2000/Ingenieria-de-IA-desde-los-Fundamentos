...
En la sección anterior identificamos los componentes que integran el contexto de un modelo de lenguaje. En esta sección profundizaremos en una idea fundamental para cualquier AI Engineer: **el contexto debe diseñarse como una arquitectura en capas**, no como un bloque de texto.
