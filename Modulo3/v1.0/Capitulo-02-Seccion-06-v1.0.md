...
Describe características relativamente estables del usuario: preferencias, idioma, zona horaria, estilo de comunicación.

## Memoria de la aplicación

Conserva estado y decisiones relevantes para el funcionamiento del sistema: procesos iniciados, configuraciones activas, autorizaciones vigentes.

## Memoria del dominio

Almacena información específica del negocio que puede reutilizarse en múltiples conversaciones: definiciones propias de la organización, jerarquías, convenciones internas.

Cada tipo posee un ciclo de vida diferente y requiere políticas propias de actualización e invalidación.
...
Esa preferencia puede almacenarse como memoria del usuario.

En futuras conversaciones ya no será necesario solicitarla nuevamente.

Sin embargo, el estado de un ticket consultado hace una semana probablemente no deba conservarse como memoria: es un dato temporal sin valor para interacciones futuras.

---

# Buenas prácticas

- Definir criterios claros de persistencia antes de implementar.
- Versionar las estructuras de memoria cuando evolucionen.
- Permitir actualizar o eliminar información de forma explícita.
- Evitar almacenar datos sensibles sin una justificación clara.
