...
Las instrucciones del sistema proporcionan estabilidad, pero por sí solas no alcanzan para responder correctamente en un entorno empresarial. Cada interacción ocurre dentro de un contexto de ejecución particular que cambia continuamente.

El contexto de ejecución reúne toda la información dinámica necesaria para interpretar una solicitud en un instante determinado.

---

# ¿Qué es el contexto de ejecución?

Es el conjunto de datos temporales que describen el estado actual de la aplicación, del usuario y del entorno.

A diferencia de las instrucciones del sistema, estos datos pueden variar entre dos solicitudes consecutivas.
...
- Incorporar únicamente información necesaria.
- Evitar duplicar datos presentes en otras capas.
- Registrar el origen de la información cuando sea relevante para auditoría.
