...
Se agregaron secciones explícitas para cubrir requisitos editoriales pendientes:

- Analogía para el análisis de casos.
- Laboratorio estructurado de análisis de un caso propio.
- Preguntas de reflexión.
- Glosario breve.

También se ajustó la numeración de secciones posteriores para mantener coherencia interna. El capítulo conserva su orientación principal: convertir conceptos del Módulo I en decisiones arquitectónicas justificadas.
