...
- Costos acotados en tests: usar `max_tokens=256` o `max_tokens=512` en los LLMs de test para limitar el costo de la suite, configurado via variable de entorno `TEST_MAX_TOKENS` independiente del config de producción
