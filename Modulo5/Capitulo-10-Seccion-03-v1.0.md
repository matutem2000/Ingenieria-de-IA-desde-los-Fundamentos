...
- Gateway como clase Python: `class LLMGateway: def __init__(self, provider, model, ...); def complete(self, messages, **kwargs) -> LLMResponse: # retry, logging, metrics`, inyectada via dependency injection en los servicios que la usan
