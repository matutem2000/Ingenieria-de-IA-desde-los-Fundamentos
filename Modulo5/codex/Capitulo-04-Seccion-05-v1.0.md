...
- Circuit breaker vía feature flag: monitorear métricas de calidad (tasa de respuestas incorrectas, latencia P99) y desactivar el flag automáticamente vía API del sistema de feature flags cuando una métrica supera un umbral, sin intervención manual
...
Los feature flags son la herramienta de resiliencia más rápida para sistemas de IA en producción: un rollback vía flag tarda segundos mientras que un rollback vía redeploy puede tardar minutos, y en una degradación activa cada segundo cuenta.
