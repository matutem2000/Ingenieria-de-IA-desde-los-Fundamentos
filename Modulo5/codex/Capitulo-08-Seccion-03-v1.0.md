...
- Nivel de detalle configurable: en desarrollo loggear el prompt completo y la respuesta completa; en producción loggear solo metadata (tokens, latencia, costo) por defecto, con logging completo activable vía feature flag para debugging específico de un `user_id` o `session_id`
