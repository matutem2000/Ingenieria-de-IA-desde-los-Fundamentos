...
- Google Vertex AI: autenticación con OAuth2 vía service account JSON o Application Default Credentials, endpoint dinámico `{region}-aiplatform.googleapis.com`, soporte nativo multimodal con `inline_data` y `file_data`
