...
- Asíncrono con Celery o ARQ: workers Python consumen tareas de una cola Redis o RabbitMQ, llaman al LLM y actualizan el estado en la base de datos; el cliente consulta el estado via polling sobre un endpoint REST de status
