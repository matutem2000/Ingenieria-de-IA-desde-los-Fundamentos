...
- Límites de gasto configurables: configurar `spending_limits` en la consola del proveedor y alertas via webhook o email antes de alcanzar el límite, evitando interrupciones de servicio por cuota agotada
