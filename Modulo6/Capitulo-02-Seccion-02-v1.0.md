...
- nomic-embed-text-v1.5 (Nomic AI): modelo open source con arquitectura modificada de BERT; 137M parámetros; soporte MRL; contexto de 8192 tokens; disponible via Ollama para inferencia local sin GPU de alta gama
