...
- Índice canary: dirigir un porcentaje pequeño del tráfico (1–5%) al nuevo índice mientras el resto sigue en el índice estable; comparar métricas de calidad (faithfulness, answer relevancy vía LLM-judge) y latencia entre ambos índices en tiempo real antes de completar la migración
