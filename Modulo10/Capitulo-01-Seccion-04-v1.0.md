...
- Platform engineering: Internal Developer Platform con Service Catalog (Backstage), Infrastructure as Code (Terraform, Pulumi), y self-service via portales web
