...
- MLflow Projects: especificación de entornos reproducibles via `MLproject` YAML con conda environment o Docker container, permitiendo reproducir cualquier experimento con `mlflow run`
