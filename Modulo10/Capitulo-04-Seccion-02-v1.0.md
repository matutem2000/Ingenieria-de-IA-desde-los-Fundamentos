...
- Feast: open source, deployment self-managed en Kubernetes, soporte para batch y streaming features via Kafka, bajo costo de licencia pero mayor esfuerzo operativo del equipo de plataforma
