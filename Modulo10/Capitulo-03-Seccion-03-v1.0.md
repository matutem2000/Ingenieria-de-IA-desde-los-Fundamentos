...
- Audit logs: registro inmutable de todas las acciones (push, pull, delete, permission change) con timestamp, usuario y IP, exportable a SIEM corporativo via webhook o API
