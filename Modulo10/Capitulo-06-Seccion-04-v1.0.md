...
- Feature engineering unit tests: tests de PyTest que validan cada función de transformación con inputs edge case (valores nulos, strings vacíos, valores fuera de rango esperado) de forma aislada
...
En un pipeline de MLOps, un test que no puede ejecutarse en el entorno de CI (por depender de datos de producción, GPU, o servicios externos) no es un test efectivo: todos los tests críticos deben poder ejecutarse en un entorno reproducible y aislado.
