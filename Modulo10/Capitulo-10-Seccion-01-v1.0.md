...
- Configuración hardcodeada: valores de configuración (bucket names, endpoint URLs, thresholds) embebidos en el código en lugar de inyectados via environment variables o ConfigMaps; cada cambio de configuración requiere redeploy
