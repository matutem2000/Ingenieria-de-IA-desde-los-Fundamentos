...
- Anuncio formal: notificación con mínimo 90 días de antelación via developer portal, email a propietarios técnicos de equipos consumidores, y deprecation warning en los responses del componente via headers HTTP estándar
