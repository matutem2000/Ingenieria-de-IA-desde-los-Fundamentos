...
## Sección 07 — PromptOps: gobierno del ciclo de vida
...
A medida que las aplicaciones basadas en LLM crecen en tamaño y criticidad, gestionar los prompts de manera manual deja de ser viable.
...
> **Nota:** PromptOps es una disciplina en consolidación dentro del ecosistema de AI Engineering. Sus principios y herramientas continúan evolucionando a medida que las plataformas empresariales basadas en LLM maduran.
...
En la próxima sección analizaremos la relación entre PromptOps, LLMOps y MLOps, identificando responsabilidades, puntos de integración y diferencias dentro de una plataforma empresarial de IA.
