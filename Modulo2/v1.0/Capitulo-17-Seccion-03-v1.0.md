...
Describir el resultado esperado no siempre es suficiente. El formato puede ser complejo, existir múltiples interpretaciones válidas o requerirse un estilo muy específico.
...
Un prompt One-Shot aplicado a la conversión de reportes técnicos luce así:

```
Convertí el siguiente reporte técnico al formato Markdown corporativo.

Ejemplo:
Entrada: "El sistema procesó 1.200 registros el martes."
Salida:
...
Ahora convertí este:
Entrada: "El servidor principal estuvo caído 3 horas el viernes."
```

La estructura es siempre la misma: instrucción, par entrada/salida de referencia, y la consulta real al final.
...
- Seleccionar un ejemplo representativo del caso más frecuente.
...
- Contradecir las instrucciones mediante el ejemplo: si la instrucción pide una lista numerada pero el ejemplo usa viñetas, el modelo priorizará el ejemplo sobre la instrucción.
