...
## Sección 02 — Zero-Shot Prompting
...
Un prompt Zero-Shot típico para clasificación de texto luce así:

```
Clasificá el siguiente texto en una de estas categorías: queja, consulta, sugerencia.

Texto: "El paquete llegó dañado y nadie responde mis mensajes."
```

El modelo infiere el criterio de clasificación únicamente a partir de las instrucciones, sin ejemplos de referencia.
...
Una señal práctica para evaluar si Zero-Shot es suficiente: si en una muestra representativa de ejecuciones un porcentaje significativo de respuestas requiere corrección manual, es momento de considerar la incorporación de ejemplos mediante One-Shot o Few-Shot.
