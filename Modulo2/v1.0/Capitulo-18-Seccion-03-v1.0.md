...
## Sección 03 — Determinismo y consistencia
...
Los Large Language Models (LLM) son sistemas probabilísticos.
...
- configuración de temperatura —el parámetro que controla el grado de aleatoriedad en la generación de tokens: valores altos producen más variedad, valores bajos generan respuestas más predecibles—;
- cambios en el contexto recibido;
- modificaciones del prompt;
- actualización del modelo;
- diferencias en los ejemplos Few-Shot (demostraciones de entrada-salida incluidas en el prompt para guiar al modelo);
- información recuperada dinámicamente mediante Retrieval-Augmented Generation (RAG), técnica que incorpora información recuperada dinámicamente desde una base de conocimiento.
