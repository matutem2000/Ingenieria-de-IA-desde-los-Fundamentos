...
Los primeros usuarios de Large Language Models improvisaban cada prompt desde cero.
...
A lo largo de este capítulo estudiaremos los principales patrones modernos.

| Patrón | Objetivo principal |
|--------|--------------------|
| Zero-Shot | Resolver tareas sin ejemplos previos. |
| One-Shot | Guiar el comportamiento mediante un ejemplo. |
| Few-Shot | Generalizar a partir de múltiples ejemplos. |
| Chain of Thought | Favorecer el razonamiento paso a paso. |
| ReAct | Combinar razonamiento y acciones. |
| Tree of Thoughts | Explorar múltiples caminos de resolución. |
| Self-Consistency | Comparar distintos razonamientos antes de responder. |

Cada uno responde a problemas diferentes y presenta ventajas y limitaciones particulares.
