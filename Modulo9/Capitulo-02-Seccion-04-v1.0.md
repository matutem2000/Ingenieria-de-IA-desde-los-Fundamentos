...
- Indirect extraction via roleplay: instruir al modelo a actuar como un asistente que está "enseñando" sus instrucciones a un nuevo modelo, o a escribir una "documentación" del sistema — el modelo puede seguir el roleplay y revelar el system prompt en ese contexto
- Extraction via tool calling: en sistemas agénticos, instruir al modelo a usar una herramienta con el contenido del system prompt como argumento, exfiltrando el prompt a través del log de herramientas o el historial de conversación
