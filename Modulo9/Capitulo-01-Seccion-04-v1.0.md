...
- STRIDE aplicado a LLMs: Spoofing del identity del sistema via prompt injection, Tampering de outputs via manipulación del contexto, Repudiation por falta de logs inmutables de inferencia, Information Disclosure via prompt leaking o memorización, DoS via context-flooding, y Elevation of Privilege via jailbreak
