...
- Model extraction: reconstrucción del comportamiento propietario via queries sistemáticas a la API; técnicamente indistinguible de distillation legítima; prevenida con rate limiting y monitoreo de patrones de query
