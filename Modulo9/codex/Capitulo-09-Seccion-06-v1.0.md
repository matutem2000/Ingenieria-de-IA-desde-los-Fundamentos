...
- GDPR en IA: base legal por cada finalidad de procesamiento, minimización activa de datos en logs, machine unlearning para el derecho al olvido, BAAs con proveedores de cloud, transferencias internacionales vía SCCs
