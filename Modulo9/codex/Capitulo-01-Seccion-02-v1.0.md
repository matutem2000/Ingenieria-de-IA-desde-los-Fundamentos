...
- Model attacks: model extraction vía consultas sistemáticas a la API para reconstruir el comportamiento del modelo, membership inference para detectar si un dato específico fue parte del entrenamiento, y fine-tuning adversarial para insertar backdoors activados por tokens trigger
