...
- Garak (NVIDIA, open-source): más de 100 probes organizadas en categorías como jailbreak, data leakage, hallucination, toxicity, RLHF bypass; genera un reporte estructurado con tasa de éxito por categoría de ataque; soporta múltiples modelos vía plugins (OpenAI, Hugging Face, Anthropic, Replicate)
