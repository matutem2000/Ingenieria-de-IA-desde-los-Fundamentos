...
- Integración en SDLC: red teaming ligero en CI/CD (Garak) + ejercicio completo pre-release + red teaming periódico en producción, triggereado por cambios de modelo, system prompt o herramientas
