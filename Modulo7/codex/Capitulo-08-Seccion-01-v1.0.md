...
- **Exfiltración de datos vía tool use**: un agente comprometido por prompt injection puede ser instruccionado para exfiltrar datos del contexto a través de herramientas disponibles (enviar datos vía HTTP a un URL externo, escribir datos en un archivo accesible externamente)
