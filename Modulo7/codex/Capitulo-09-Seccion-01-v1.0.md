...
- **Síncrono con streaming**: el servidor envía events vía Server-Sent Events (SSE) o WebSocket mientras el agente ejecuta; el cliente recibe cada paso del agente (tool call, observation, reasoning) en tiempo real sin esperar el resultado final; mejora la UX en tareas de 10-60 segundos
