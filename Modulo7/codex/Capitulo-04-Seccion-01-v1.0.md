...
- **Working memory**: subconjunto del contexto activo que el agente mantiene actualizado como estado de la tarea actual; análogo al `AgentState` en LangGraph, que persiste entre iteraciones del ciclo agéntico
