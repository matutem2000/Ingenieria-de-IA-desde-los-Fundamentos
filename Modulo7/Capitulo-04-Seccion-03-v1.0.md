...
- **Retrieval selectivo**: antes de cada sesión o tarea, recuperar el subset más relevante de la memoria; criterios de recuperación: recencia (últimas N sesiones), relevancia semántica (top-k por similaridad coseno con la query actual), importancia (ítems marcados como high-priority)
