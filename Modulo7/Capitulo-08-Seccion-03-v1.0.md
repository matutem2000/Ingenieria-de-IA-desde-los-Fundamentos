...
- **Tool scope por tarea**: en lugar de proveer al agente un conjunto fijo de todas las herramientas disponibles, definir subsets de herramientas específicos por tipo de tarea; el routing al agente correcto con el subset apropiado es más seguro que herramientas disponibles universalmente
