...
- **Filtrado por metadata antes del ANN search**: aplicar filtros hard (user_id, date_range, type) antes de la búsqueda vectorial para reducir el espacio de búsqueda y mejorar precisión; la mayoría de vectorstores soportan filtrado pre-ANN via metadata fields
