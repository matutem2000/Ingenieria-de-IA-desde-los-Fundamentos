...
- Gestión de identidad y acceso: roles IAM por función (AI Engineer, Data Scientist, Operator) con principio de mínimo privilegio, MFA obligatorio, y acceso Just-In-Time para operaciones privilegiadas
