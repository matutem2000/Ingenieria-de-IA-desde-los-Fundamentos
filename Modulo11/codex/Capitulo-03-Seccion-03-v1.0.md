...
- Capacidad de exploración: ELT permite a los ingenieros de IA explorar datos crudos en el data lake para identificar features nuevas sin modificar el pipeline de transformación existente
