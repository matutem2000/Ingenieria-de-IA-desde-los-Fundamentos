...
- Asistente de ventas: integración con PIM (Product Information Management) y ERP para datos de precios en tiempo real vía Text-to-SQL, corpus de documentación de producto, y sistema de alertas cuando la información del índice tiene más de 24 horas de antigüedad
