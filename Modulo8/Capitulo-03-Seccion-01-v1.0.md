...
- Formatos de compilación: disponible como binario standalone, librería estática `.a` para integración C/C++, y bindings Python via `llama-cpp-python` que expone una API de alto nivel y un servidor OpenAI-compatible en Python
