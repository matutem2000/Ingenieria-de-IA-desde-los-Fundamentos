...
- Comportamiento ante casos límite: el few-shot prompting no garantiza comportamiento correcto en inputs que difieren del patrón de los ejemplos; el fine-tuning sobre un dataset diverso que incluye casos límite mejora la robustez ante entradas inesperadas
