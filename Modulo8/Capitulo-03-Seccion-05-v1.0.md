...
- Latencia de carga inicial: si el modelo no está en memoria (cold start), llama.cpp debe leer el archivo GGUF desde disco y cargarlo en RAM/VRAM, proceso que puede tardar 5-30 segundos para modelos de 7B-70B dependiendo de la velocidad del almacenamiento
